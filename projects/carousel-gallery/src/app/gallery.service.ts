...
export class GalleryService {
  ...
  private previousImageIndex: BehaviorSubject<number> = new BehaviorSubject(this.images.value.length-1);
  ...
  getNextImage() {
    this.currentImageIndex.next(this.currentImageIndex.value + 1 == this.images.value.length ? 0 : this.currentImageIndex.value + 1);
    this.previousImageIndex.next(this.previousImageIndex.value + 1 == this.images.value.length ? 0 : this.previousImageIndex.value + 1);
  }

    getPreviousImage() {
    this.currentImageIndex.next(this.currentImageIndex.value == 0 ? this.images.value.length-1 : this.currentImageIndex.value - 1);
    this.previousImageIndex.next(this.previousImageIndex.value == 0 ? this.images.value.length-1 : this.previousImageIndex.value - 1);
  }
